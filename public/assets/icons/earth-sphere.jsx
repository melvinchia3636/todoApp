  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M9.06 5.646A6.977 6.977 0 0 1 12 5a6.998 6.998 0 0 1 6.184 3.718l-2.015.671a3 3 0 0 0-1.851 3.923l1.7 4.42A6.97 6.97 0 0 1 12 19a6.985 6.985 0 0 1-2.519-.467l1.564-1.369a2.44 2.44 0 0 0-.515-4.017.44.44 0 0 1-.067-.744l.473-.355a2.804 2.804 0 0 0 .3-4.226L9.06 5.646zm-1.708 1.12A6.984 6.984 0 0 0 5 12c0 2.221 1.035 4.2 2.646 5.481l2.082-1.822a.44.44 0 0 0-.093-.723c-1.621-.811-1.823-3.045-.372-4.133l.473-.355a.804.804 0 0 0 .086-1.212l-2.47-2.47zm10.23 9.46A6.973 6.973 0 0 0 19 12c0-.479-.048-.947-.14-1.4l-2.058.687a1 1 0 0 0-.617 1.307l1.396 3.632z"
        clip-rule="evenodd"
      />
    </svg>
  );
